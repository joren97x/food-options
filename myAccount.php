                    ...
                    <div class="container ml-5">
                        ...
                        <div class="modal-body">
                            <input type="text" id="newCategory" name="newCategory" placeholder="Category Name"
                                ...
                                <input type="submit" name="createCategory" id="createCategory" value="Add Category"
                        ...
                        <div class="modal-body">
                            <div class="dropdown">
                                ...
                                <input type="text" id="newCategory2" name="newCategory2" placeholder="New Category Name"
        ...
        <!-- Button trigger modal -->
            ...
            <div class="modal-dialog">
                ...
                ?>
                    ...
                    SELECT CATEGORY<select name="newCategoryEdit" id="newCategoryEdit" class="form-control">
                    <?php
                                $query = "SELECT * FROM tblCategory";
                                $result = mysqli_query($conn, $query);
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group ">
                                    <input type="text" value="<?php echo $account['firstName']; ?>" placeholder="First Name" id="firstNameEdit" name="firstNameEdit"
                                        class="form-control my-3" style="background-color: #f4f4f4" ;>
                                    <input type="text" value="<?php echo $account['lastName']; ?>" placeholder="Last Name" id="lastNameEdit" name="lastNameEdit"
                                        class="form-control my-3" style="background-color: #f4f4f4" ;>
                                    <input type="text" value="<?php echo $account['email']; ?>" placeholder="Email" id="emailEdit" name="emailEdit"
                                        class="form-control my-3 " style="background-color: #f4f4f4" ;>
                                    <input type="password" value="<?php echo $account['password']; ?>" id="password2" name="password2" placeholder="Password"
